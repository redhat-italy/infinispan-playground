...
public class LocalConsoleCommand implements ConsoleCommand {
    ...
    public LocalConsoleCommand(PlaygroundConfiguration conf) {
    ...
    public boolean execute(UI console, Iterator<String> args) throws IllegalParametersException {
        Set<String> local = InfinispanHelper.localValuesFromKeys(cache);
    ...
    public void usage(UI console) {
        ...
        console.println("\t\tList all local values.");
    }
}
